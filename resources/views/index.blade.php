                    ...
                    <div class="carousel-item active">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-5 ">
                                    <div class="img-box">
                                        <img src="{{asset('admin_assets/images/slider-img.png')}}" alt=""/>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="box">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <div class="img-box">
                        <img src="{{asset('admin_assets/images/saving-img.png')}}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="detail-box">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="img_container">
                        <div class="img-box">
                            <img src="{{asset('admin_assets/images/gifts.png')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="detail-box">
                        ...
                        <p>
                            Omnis ex nam laudantium odit illum harum, excepturi accusamus at corrupti, velit blanditiis
                            unde perspiciatis, vitae minus culpa? Beatae at aut consequuntur porro adipisci aliquam
